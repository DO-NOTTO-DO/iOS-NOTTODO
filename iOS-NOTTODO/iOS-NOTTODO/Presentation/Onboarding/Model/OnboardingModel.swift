...
extension SecondOnboardingModel {
    static let titles: [SecondOnboardingModel] = [
        SecondOnboardingModel(title: "고치고 싶은 나쁜 습관이 있어요"),
...
extension FourthOnboardingModel {
    static let items: [FourthOnboardingModel] = [
        FourthOnboardingModel(icon: .youtube, tag: "취침 전", title: "유튜브 추천 영상 생각없이 보지 않기"),
...
extension FifthOnboardingModel {
    static let titles: [FifthOnboardingModel] = [
        FifthOnboardingModel(title: "배고플 때마다 양치하기"),
