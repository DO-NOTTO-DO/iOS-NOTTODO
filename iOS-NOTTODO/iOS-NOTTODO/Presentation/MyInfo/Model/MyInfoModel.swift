...
extension InfoModelOne {
    static let item: [InfoModelOne] = [InfoModelOne(image: "img_myinfouser", user: "내이름은노또", email: "ghdtjgus123@kakao.com")]
}
...
extension InfoModelTwo {
    static let items: [InfoModelTwo] = [InfoModelTwo(image: "btn_checkbox_inactive", title: "낫투두 가이드"),
                                        InfoModelTwo(image: "btn_checkbox_inactive", title: "자주 묻는 질문")
    ]
}
